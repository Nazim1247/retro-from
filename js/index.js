...
const displayAllPost = (posts) => {
    ...
    posts.forEach(post => {
        ...
        div.innerHTML = `<div class="p-6 lg:p-12 flex gap-6 lg:flex-row flex-col items-center lg:items-start bg-[#f3f3f5] rounded-3xl">
            <div class="indicator">
...
const markAsRead = (description, view_count) => {
    ...
    const div = document.createElement('div');
    div.innerHTML = `<div class="flex justify-between p-2 lg:p-3 bg-white rounded-2xl items-center gap-3">
...
const displayLatestPosts = (posts) => {
    ...
    posts.forEach(post => {
        const div = document.createElement('div');
        div.innerHTML = `
        <div class="card lg:w-11/12 pb-5 bg-base-100 shadow-2xl">
          ...
          <div class="p-5 lg:p-10 space-y-4 lg:space-y-5">
              ...
              <div>
              <h3 class="text-start font-extrabold">${post.author.name ? `${post.author.name}` : 'Not found Name'}</h3>
